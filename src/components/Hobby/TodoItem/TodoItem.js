...
import {H_check_item, H_delete_item } from "../../Hobby/TodoItem/SliceTodoItem";
...
return(
   <SeveralItemContainer>
      ...
      <img onClick={()=>dispatch(H_check_item())} className="noncheck" src = {item.isDone ? check: noncheck} alt="icon"></img>
      </TitleContainer>
      <ContentContainer>
      <div className="content">{item.content}</div>
      <img onClick={()=>dispatch(H_delete_item(item.id))} className='delete' src={del} alt="icon"></img>
      </ContentContainer>
