...
import {R_check_item, R_delete_item } from "./SliceTodoItem";
...
return(
   <SeveralItemContainer>
      ...
      <img onClick={()=>dispatch(R_check_item())} className="noncheck" src = {item.isDone ? check: noncheck} alt="icon"></img>
      </TitleContainer>
      <ContentContainer>
      <div className="content">{item.content}</div>
      <img onClick={()=>dispatch(R_delete_item(item.id))} className='delete' src={del} alt="icon"></img>
      </ContentContainer>
