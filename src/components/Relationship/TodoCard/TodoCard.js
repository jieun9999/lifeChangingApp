...
import TodoItem from "../../Relationship/TodoItem/TodoItem";
import styled from "styled-components";
import React from "react";
import { useSelector } from "react-redux";
import TodoModal from "../../Relationship/Modal/TodoModal";
...
const TodoCard = () =>{
    ...
    const todoModalContent = useSelector((state)=> state.relaTodoContent.relaTodoContent) // store에 맞게 수정
