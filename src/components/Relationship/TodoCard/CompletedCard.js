...
import CompletedItem from "../../Relationship/TodoItem/CompletedItem";
import styled from "styled-components";
import React from "react";
import {useSelector } from "react-redux";
import CompletedModal from "../../Relationship/Modal/CompletedModal";
...
const CompletedCard = ()=>{
    ...
    const completedModalContent = useSelector((state)=> state.relaCompletedContent.relaCompletedContent) // store에 맞게 수정
