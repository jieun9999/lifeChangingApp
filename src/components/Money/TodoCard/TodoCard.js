...
import TodoItem from "../../Money/TodoItem/TodoItem";
import styled from "styled-components";
import React from "react";
import { useSelector } from "react-redux";
import TodoModal from "../../Money/Modal/TodoModal";
...
const TodoCard = () =>{
    ...
    const todoModalContent = useSelector((state)=> state.moneyTodoContent.moneyTodoContent) // store에 맞게 수정
