...
import {M_check_item, M_delete_item } from "../../Money/TodoItem/SliceTodoItem";
...
return(
   <SeveralItemContainer>
      ...
      <img onClick={()=>dispatch(M_check_item())} className="noncheck" src = {item.isDone ? check: noncheck} alt="icon"></img>
      </TitleContainer>
      <ContentContainer>
      <div className="content">{item.content}</div>
      <img onClick={()=>dispatch(M_delete_item(item.id))} className='delete' src={del} alt="icon"></img>
      </ContentContainer>
